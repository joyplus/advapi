    ...
    private function print_ad($display_ad){
        ...
        if ($display_ad['main_type']=='display'){
            ...
            switch ($display_ad['response_type']){
                ...
                case 'xml':
                    ...
                    if(!is_null($display_ad['interstitial-creative_res_url']) && $display_ad['interstitial-creative_res_url']!=''){
                        $response.= '<creative_res_url src="'.$display_ad['interstitial-creative_res_url'].'" sourcetype="'.$display_ad['adv_type'].'" hash="'.$display_ad['file_hash_1'].'"></creative_res_url>';
                    }
            ...
            if($display_ad['type']=='open') {
            	...
            	$response.= '<creative sourcetype="'.$display_ad['adv_type'].'" display="'.$display_ad['video-creative-display'].'" delivery="'.$display_ad['video-creative-delivery'].'" type="'.$display_ad['video-creative-type'].'" bitrate='.$display_ad['video-creative-bitrate'].'"" width="'.$display_ad['video-creative-width'].'" height="'.$display_ad['video-creative-height'].'" hash=""><![CDATA['.$display_ad['creative-url'].']]></creative>';
            	$response.= '<creative2 sourcetype="'.$display_ad['adv_type'].'" display="'.$display_ad['video-creative-display'].'" delivery="'.$display_ad['video-creative-delivery'].'" type="'.$display_ad['video-creative-type'].'" bitrate='.$display_ad['video-creative-bitrate'].'"" width="'.$display_ad['video-creative-width'].'" height="'.$display_ad['video-creative-height'].'" hash="'.$display_ad['file_hash_1'].'"><![CDATA['.$display_ad['creative-url_2'].']]></creative2>';
            	$response.= '<creative3 sourcetype="'.$display_ad['adv_type'].'" display="'.$display_ad['video-creative-display'].'" delivery="'.$display_ad['video-creative-delivery'].'" type="'.$display_ad['video-creative-type'].'" bitrate='.$display_ad['video-creative-bitrate'].'"" width="'.$display_ad['video-creative-width'].'" height="'.$display_ad['video-creative-height'].'" hash="'.$display_ad['file_hash_2'].'"><![CDATA['.$display_ad['creative-url_3'].']]></creative3>';
            	$response.= "<impressionurl><![CDATA[";
            	$response.= "".$display_ad['final_impression_url']."";
            	$response.= "]]></impressionurl>";
            	$response.= "<trackingurl_miaozhen><![CDATA[";
