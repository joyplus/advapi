...
class MDTrackController extends RESTController{
	...
	//	}
		...
		if ($repcard_detail !=null && $repcard_detail->entry_id>0){ 
			...
			$sql = "UPDATE md_reporting set  total_impressions=total_impressions+ ".$add_impression." WHERE entry_id='".$repcard_detail->entry_id."'";
			$resultSet = new ResultSet(null, $reporting, $reporting->getReadConnection()->query($sql));
		}
		else { 
